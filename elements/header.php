    ...
    <div id="main-header">
        <div id="header">
            ...
            <div class="right-block">
                <ul class="lang">
                    <li>
                        <a data-language-switch href="<?php echo htmlspecialchars(site_language_selection_url('et'), ENT_QUOTES, 'UTF-8'); ?>"<?php if (site_language() === 'et'): ?> class="active"<?php endif; ?>>
                            EE
                        </a>
                    </li>
                    <li>
                        <a data-language-switch href="<?php echo htmlspecialchars(site_language_selection_url('ru'), ENT_QUOTES, 'UTF-8'); ?>"<?php if (site_language() === 'ru'): ?> class="active"<?php endif; ?>>
                            RU
                        </a>
                    </li>
                    <li>
                        <a data-language-switch href="<?php echo htmlspecialchars(site_language_selection_url('en'), ENT_QUOTES, 'UTF-8'); ?>"<?php if (site_language() === 'en'): ?> class="active"<?php endif; ?>>
                            ENG
                        </a>
                    </li>
                </ul>
